...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Ashiqul Islam
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I am a full stack web developer. who has design and development very much website in </p>
